...
CovidDataTrain2= dplyr::select(CovidDataTrain, Class, armed_forces, female_female_households, vacant_housing_units, hispanic_male_55_64, commute_90_more_mins, owner_occupied_housing_units_median_value, hispanic_male_45_54, median_rent, hispanic_pop, median_year_structure_built)
CovidDataTrainScaled = CovidDataTrain2 %>% dplyr::mutate_if(is.numeric, scale)
CovidDataTest2=dplyr::select(CovidDataTest, Class, armed_forces, female_female_households, vacant_housing_units, hispanic_male_55_64, commute_90_more_mins, owner_occupied_housing_units_median_value, hispanic_male_45_54, median_rent, hispanic_pop, median_year_structure_built)
...
#REMOVE confirmed cases and other features we do not want to train on
deathDataTrain2= dplyr::select(deathDataTrain, Class, armed_forces, female_female_households, vacant_housing_units, hispanic_male_55_64, commute_90_more_mins, owner_occupied_housing_units_median_value, hispanic_male_45_54, median_rent, hispanic_pop, median_year_structure_built)
deathDataTrainScaled = deathDataTrain2 %>% dplyr::mutate_if(is.numeric, scale)
deathDataTest2=dplyr::select(deathDataTest, Class, armed_forces, female_female_households, vacant_housing_units, hispanic_male_55_64, commute_90_more_mins, owner_occupied_housing_units_median_value, hispanic_male_45_54, median_rent, hispanic_pop, median_year_structure_built)
...
ctreeFitCovid <- CovidDataTrainScaled %>% train(Class ~ .,
                                                ...
                                                parms = list(split ="information"))
ctreeFitDeath
rpart.plot(ctreeFitCovid$finalModel, extra = 2, cex = 0.65)
...
CovidDataTrain2= dplyr::select(deathDataTrain, county_name, state, Class, armed_forces, female_female_households, vacant_housing_units, hispanic_male_55_64, commute_90_more_mins, owner_occupied_housing_units_median_value, hispanic_male_45_54, median_rent, hispanic_pop, median_year_structure_built)
CovidDataTrainScaled = CovidDataTrain2 %>% dplyr::mutate_if(is.numeric, scale)
CovidDataTest2=dplyr::select(CovidDataTest, county_name, state, Class, armed_forces, female_female_households, vacant_housing_units, hispanic_male_55_64, commute_90_more_mins, owner_occupied_housing_units_median_value, hispanic_male_45_54, median_rent, hispanic_pop, median_year_structure_built)
CovidDataTestScaled=CovidDataTest2%>% dplyr::mutate_if(is.numeric, scale)
