...
# K-nearest Neighbor Deaths (not map-plotting)  
# ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
CovidDataTrain2= dplyr::select(CovidDataTrain, -deaths, -delta, -cases_norm, -county_fips_code, -geo_id, -state_fips_code, -state, -date, -confirmed_cases, -total_pop)
CovidDataTrainScaled = CovidDataTrain2 %>% dplyr::mutate_if(is.numeric, scale)
CovidDataTest2=dplyr::select(CovidDataTest,  -deaths, -delta, -cases_norm, -county_fips_code, -geo_id, -state_fips_code, -state, -date, -confirmed_cases, -total_pop)
CovidDataTestScaled=CovidDataTest2%>% dplyr::mutate_if(is.numeric, scale)
